...
{{-- Object --}}
<button type="button" class="swiper-slide btn btn-light {{ !empty($article->target_student) ? '' : 'disable' }}" data-toggle="tooltip" data-placement="bottom" data-html="true"  title="{{ !empty($article->target_student) ? $article->target_student : '' }}">
...
{{-- Fee --}}
<button type="button" class="swiper-slide btn btn-light {{ !empty($article->fee) ? '' : 'disable' }}" data-toggle="tooltip" data-placement="bottom" data-html="true"  title="{{ !empty($article->fee) ? $article->fee : '' }}">
