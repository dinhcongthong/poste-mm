...
<h2 class="article-title text-primary font-weight-bold">
    <span class="badge badge-primary"><i class="fas fa-chevron-right"></i> {{ $article->category->name }}</span>
    {{ $article->name }}
</h2>
...
<div class="modal fade" id="classify-contact" tabindex="-1" role="dialog" aria-labelledby="classify-contact-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="#" method="POST" id="contact-classify-form" data-key="{{ $article->id }}" data-type="bullboard">
