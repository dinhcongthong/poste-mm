    ...
    <div class="container">
        ...
        <div id="main-content" class="d-grid x3 g-4 mb-4">
            <div class="g-col-3 g-col-lg-2">
                <div id="article-content" class="bg-white rounded overflow-hidden p-4 mb-4">
                    ...
                    <div class="article-thumbnail mb-4 text-center row">
                        <img class="img-cover" src="{{ App\Models\Base::getUploadURL($article->getThumbnail->name, $article->getThumbnail->dir) }}" alt="{{ $article->name.','.$categoryItem->name }}">
                    </div>
                                ...
                                <a href="{{ route('get_lifetip_detail_route', $item->slug.'-'.$item->id) }}">
                                    <div class="row no-gutters p-3">
                                        ...
                                        <div class="col-8 pr-0 pl-3">
                                            <h2 class="pt-0 pb-4 m-0">{{ $item->name }}</h2>
