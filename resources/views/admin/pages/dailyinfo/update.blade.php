...
<div class="row">
    <div class="col-12 col-sm-12 py-2">
        <form action="{{ $id != 0 ? route('post_dailyinfo_edit_ad_route', ['id' => $id]) : route('post_dailyinfo_add_ad_route') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                <label class="col-12 col-sm-2 col-form-label text-right">Customer</label>
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-sm-10 col-md-7">
                    <select class="form-control select2" name="category_ids[]" multiple required>
            ...
            <div class="form-group row">
                <label class="col-12 col-sm-2 col-form-label text-right">Schedule</label>
                <div class="col-12 col-sm-10 col-md-7">
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <input class="form-control" id="start-date" name="start_date" value="{{ $startDate }}" placeholder="Start Date">
                        </div>
                        <div class="col-12 col-sm-6">
                            <input class="form-control" id="end-date" name="end_date" value="{{ $endDate }}" placeholder="End Date">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group offset-sm-2 col-12 col-sm-10 col-md-7 text-center">
                <a href="{{ route('get_dailyinfo_index_ad_route') }}" class="btn btn-outline-primary">Back</a>
