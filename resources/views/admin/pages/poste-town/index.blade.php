...
<div class="row no-gutters py-2">
    <a href="{{ route('get_town_new_route') }}" target="_blank" class="btn btn-primary ml-auto" role="button">Create New</a>
</div>
<div class="row no-gutters py-2">
    <div class="table-responsive" id="table-view">
        @include('admin.pages.poste-town.table')
    </div>
</div>
...
<div class="modal fade" id="promotion-list-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog centered-vertically modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Set Owner</h5>
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table id="promotion-list" class="table datatables table-bordered table-stripped">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->name }}</td>
                                <td class="text-center">
                                    <button class="btn btn-warning text-white set-customer" data-customer="{{ $item->id }}">SET</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
