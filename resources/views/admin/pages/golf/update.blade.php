    ...
    <div class="col-12 col-sm-12 py-2">            
        ...
        <div class="row">
            <div class="col-12 col-sm-8">
                <form action="{{ $id == 0 ? route('post_golf_add_ad_route') : route('post_golf_edit_ad_route', ['id' => $id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-10">
                            <input type="text" class="form-control" name="work_time" value="{{ $workTime }}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-12 col-sm-2 col-form-label text-right">Budget</label>
                        <div class="col-12 col-sm-10">
                            <input type="text" class="form-control" name="budget" value="{{ $budget }}" placeholder="Option">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-2 col-form-label text-right">Yard</label>
                        <div class="col-12 col-sm-10">
                            <input type="text" class="form-control" name="yard" value="{{ $yard }}" placeholder="Option">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-2 col-form-label text-right">Caddy</label>
                        <div class="col-12 col-sm-10">
                            <input type="text" class="form-control" name="caddy" value="{{ $caddy }}" placeholder="Option">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-2 col-form-label text-right">Rental</label>
                        <div class="col-12 col-sm-10">
                            <input type="text" class="form-control" name="rental" value="{{ $rental }}" placeholder="Option">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-2 col-form-label text-right">Cart</label>
                        <div class="col-12 col-sm-10">
                            <input type="text" class="form-control" name="cart" value="{{ $cart }}" placeholder="Option">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-2 col-form-label text-right">Facility</label>
                        <div class="col-12 col-sm-10">
                            <input type="text" class="form-control" name="facility" value="{{ $facility }}" placeholder="Option">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-2 col-form-label text-right">Shower</label>
                        <div class="col-12 col-sm-10">
                            <input type="text" class="form-control" name="shower" value="{{ $shower }}" placeholder="Option">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-2 col-form-label text-right">Lesson</label>
                        <div class="col-12 col-sm-10">
                            <input type="text" class="form-control" name="lesson" value="{{ $lesson }}" placeholder="Option">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-2 col-form-label text-right">Golf Station Number</label>
                        <div class="col-12 col-sm-10">
                            <input type="text" class="form-control" name="golf_station_number" value="{{ $golfStationNumber }}" placeholder="Option">
                        </div>
                    </div>
                    <div class="form-group row">
